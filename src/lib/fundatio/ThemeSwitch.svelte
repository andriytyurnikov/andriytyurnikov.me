<script>
  ...
  function handleThemeSwitchClick(evt){
    themeSwitchEl.classList.remove('fundatio-animate-theme-switch');
    ...
    themeSwitchEl.classList.add('fundatio-animate-theme-switch');
...
<button 
  ...
  bind:this={themeSwitchEl} 
  on:click={(e) => { handleThemeSwitchClick(e) }}>
