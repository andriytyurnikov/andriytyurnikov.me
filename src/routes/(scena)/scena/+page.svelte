...
<div class="scena-cover scena-cover--center p-6/4r">
  <article 
    ...
    "
    >
    <h2 class="text-center max-w-upto-peri mx-auto font-bold">
      <svg class="inline-block w-16 h-16 pr-4 -mt-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <p class="lead text-center">
      Web layouts done rigth&trade;:
      antropometric,
      <span>proportionally typographical</span>,
      responsive
    </p>

    <hr class="max-w-upto-peri mx-auto border-slate-900 dark:border-slate-100"/>

    <a href="{base}/scena/docs/" class="inline-block rounded-full border border-2 border-slate-900 dark:border-slate-100 p-5/6r m-5/6r float-right">
      Get Started &rarr;
    </a>
