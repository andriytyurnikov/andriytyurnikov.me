<section
	class="min-h-dvh flex flex-col items-center justify-center px-6 relative z-[1] bg-eigengrau-950"
>
	...
	<p class="text-eigengrau-200 mt-8 text-center max-w-md">
		The web should adapt to humans, not the other way around. Scroll to explore four principles that
