...
<div class="scena-cover scena-cover--center p-6/4r">
  <article 
    ...
    <p class="text-center">
      Reasonable defaults of typographic style
    </p>

    <hr class="max-w-upto-peri mx-auto"/>

    <a href="{base}/elementa/docs/typography" class="inline-block !no-underline rounded-full border border-2 border-slate-900 dark:border-slate-100 p-5/6r float-right">
      Get Started &rarr;
    </a>
