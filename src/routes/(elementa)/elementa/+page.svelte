...
<article class="p-4 mx-auto canon metrica-font-berkeley-mono bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
  ...
  <p class="lead text-center">
    Web apps should aim to match experience of native apps.
  </p>

  <p class="mb-3">
    Components should provide cohesive, 
    integrated experience for user & developer &mdash;
  ...
  <section class="mx-auto max-w-peri">
    <ul class="elementa-list border-slate-900 dark:border-slate-100">
      ...
      <li class="elementa-list-item text-slate-600 dark:text-slate-400">
      ...
      <li class="elementa-list-item text-slate-600 dark:text-slate-400">
        ...
        Toast notifications <!-- kudos to sonner -->
      </li>
      ...
      <li class="elementa-list-item text-slate-600 dark:text-slate-400">
        ...
        Web<sup>3</sup> wallet & network info
      </li>
    </ul>
  </section>
</article>
