  ...
  <article class="grid portrait:grid-template-row-split landscape:grid-template-col-split">
    <header class="contents">
      ...
      <p class="relative responsive-grid-split-cell w-auto z-30 pt-4/1r landscape:h-screen portrait:h-[50vh]">
        ...
        <svg class="absolute motion-safe:animate-bounce w-16 h-16 bottom-8 right-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.5" stroke="currentColor">
